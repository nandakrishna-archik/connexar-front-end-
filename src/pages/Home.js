    ...
    <>
      ...
      <div className="main">
        ...
        >
          ...
          >
            <h2 className="ani font-weight-bold text-white ">
        ...
        <section className="par_sec">
          <div className="container p-4">
            <div className="para_grph">
              <p className="ab  h1 mt-3">
                Why Do We choose the foreign exchange Market ?
              </p>
              <p className="mt-4  desc">
               <h5>The forex market is the place for traders all around the world
                ...
                world’s most popular tradable instrument.</h5>
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container ">
            <div className="row">
              <div className="col-sm-6 d-flex align-items-center">
                <h5 className="mb-0 text-white"><h4>Open Your Account </h4> </h5></div>
